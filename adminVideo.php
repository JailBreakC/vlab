<div class="container">
    <h2>视频资源</h2>
    <h3 style="color:red">请先将MP4格式的视频文件放入网站根目录下的video文件夹中！</h3>
    <hr>
    <h3>首页展示缩略图</h3>
    ...
    <h4>在下面填写视频文件名。（请使用英文文件名如：video.mp4）</h4>
    <p><input id="name" placeholder="视频文件名" type="text" class="form-control"></p>
    <div class="btn-toolbar" data-role="editor-toolbar" data-target="#editor">
      ...
      <button id="new" class="btn btn-success pull-right">新增资源</button>
    </div>
